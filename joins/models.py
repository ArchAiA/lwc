...
class Join(models.Model):
	...
	friend = models.ForeignKey("self", related_name="referral", null=True, blank=True) #The person that sent the invite to this particular user
...
"""L28: Saving Shares by Reference ID - #1 The Long Way"""
